...
def report(path, quiet, limit):
    ...
    json_path = os.path.join(
        "/home/ubuntu/verb-workspace/WAVES/data/results", #os.environ.get("RESULT_DIR"),
        str(path).split("/")[-2],
...
if __name__ == "__main__":
    paths = ["/home/ubuntu/verb-workspace/WAVES/data/attacked/imagenet/resnet18-2-tree_ring",
             "/home/ubuntu/verb-workspace/WAVES/data/attacked/imagenet/resnet18_pwm-2-tree_ring",
             "/home/ubuntu/verb-workspace/WAVES/data/attacked/imagenet/none-2-tree_ring"]
    #"/home/ubuntu/verb-workspace/WAVES/data/attacked/imagenet/resnet18-2-real", 
    #"/home/ubuntu/verb-workspace/WAVES/data/attacked/imagenet/resnet18_pwm-2-real"
    #"/home/ubuntu/verb-workspace/WAVES/data/attacked/imagenet/none-2-real",
    for p in paths:
