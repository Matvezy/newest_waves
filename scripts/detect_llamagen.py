...
from llamagen.lm_watermarking.extended_watermark_processor import WatermarkLogitsProcessor, WatermarkDetector
...
def main(args):
    ...
    watermark_detector = WatermarkDetector(vocab=vocab,
                                        ...
                                        tokenizer=None, # What about here
                                        z_threshold=4.0,
                                        normalizers=[],
